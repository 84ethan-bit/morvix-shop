...
async def test_full_deals_page():
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print("🎯 [발굴된 핫딜 전용 URL 정밀 수집 테스트]")
    ...
    async with async_playwright() as p:
        ...
        for scroll_idx in range(1, 16):
            ...
            if cur_count == prev_count and scroll_idx > 5:
                print("  ✅ 스크롤 끝 도달 (더 이상 상품이 늘어나지 않음)")
                break
            prev_count = cur_count

        # 3. 전수 상품 데이터 추출 (상품명, 가격, 할인율, 쉐어링크 버튼)
        ...
        print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print(f"🎉 [전수 수집 성공 팩트 수치] : 총 {len(products)}개 핫딜 상품 발굴!")
        print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
...
if __name__ == "__main__":
    asyncio.run(test_full_deals_page())

...
SHOT_DESK = os.path.abspath(os.path.join(os.path.dirname(__file__), "disclosure_ui_desktop.png"))
SHOT_MOB = os.path.abspath(os.path.join(os.path.dirname(__file__), "disclosure_ui_mobile.png"))
...
async def test_disclosure_ui():
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(f"🚀 [로컬 HTTP 서버(port {PORT}) 기동 & 토스 권고문구 UI 실측]")
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    ...
    async with async_playwright() as p:
        ...
        await page_desk.goto(f"http://localhost:{PORT}/index.html", wait_until="networkidle", timeout=30000)
        ...
        await page_mob.goto(f"http://localhost:{PORT}/index.html", wait_until="networkidle", timeout=30000)
    ...
    print("\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(f"🎉 [검증 완수] 토스 권고문구 소프트 블루 배경 & 💡 아이콘 & 차콜 폰트 적용 완수!")

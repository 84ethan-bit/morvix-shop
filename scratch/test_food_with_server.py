...
async def test_food_clean_http():
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print("🚀 [로컬 HTTP 서버(8089) 기동 & 식품 탭 100% 순수 노출 검증]")
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")

    # Start HTTP server
    proc = subprocess.Popen([sys.executable, "-m", "http.server", "8089"], cwd=ROOT_DIR, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    time.sleep(1.5)
    ...
    try:
        async with async_playwright() as p:
            ...
            await page.goto("http://localhost:8089/index.html", wait_until="networkidle", timeout=30000)
...
if __name__ == "__main__":
    asyncio.run(test_food_clean_http())
